...
namespace Test
{
    ...
    class Test
    {
        ...
        public static void Main(String[] args)
        {
            ...
            string[] answer = PrintNumberLibrary.PrintNumberClass.printnumber(15, new KeyValuePair<int, string>(2, "hi"), new KeyValuePair<int, string>(3, "fizz"), new KeyValuePair<int, string>(5, "buzz"));
